...
class RNNSLU(object):
    ...
    def __init__(self, nh, nc, ne, de, cs):
        ...
        def recurrence(x_t, h_tm1):
            ...
            #print('x_t ', x_t.shape.eval())
            print('wx ', self.wx.shape.eval())
            #print('h_tm1 ', h_tm1.shape.eval())
            print('wh ', self.wh.shape.eval())
            print('bh ', self.bh.shape.eval())
            print('w ', self.w.shape.eval())
            print('b ', self.b.shape.eval())
    ...
    def train(self, x, y, window_size, learning_rate):
        ...
        #print("[embeddings of row 42] %s" %self.emb.get_value()[42])
...
def saveStuff(folder, stuff, filename):
    numpy.save(os.path.join(folder,
                       filename + '.npy'), stuff)

def loadStuff(stuff):
    res = numpy.load(stuff)
    return res
...
def main(param=None):
    ...
    print('Folder to save stuff [%s]' %folder)
    ...
    saveStuff('rnnslu', vocwords, 'words')
